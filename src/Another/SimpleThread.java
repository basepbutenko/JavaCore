...
public class SimpleThread extends Thread {
    public static void main(String[] args) {
        ...
        // для создания потока нам необходимо обратиться к классу Course4.Course4.Course4.Lesson1.Thread
    ...
    public void run() {
       ...
       // super.run(); это метод родителя, мы его не используем, вместо него используем цикл for нажав fori
        ...
        // далее нам необходимо создать экземпляр описанного класса Another.SimpleThread и передать в конструктор Course4.Course4.Course4.Lesson1.Thread
    }
}
